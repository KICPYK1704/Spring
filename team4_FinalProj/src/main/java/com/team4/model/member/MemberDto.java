...
public class MemberDto {
	...
	public String getMem_fandesignerno() {
		return mem_fandesignerno;
	}

	public void setMem_fandesignerno(String mem_fandesignerno) {
		this.mem_fandesignerno = mem_fandesignerno;
	}
