		...
		<div class="row center-align">
			<form class="col s12 center" action="memberregister" name="memberregister" method="post">
			    <div class="input-field col s6 offset-s3">
			      ...
			      <input id="icon_prefix" type="text" name ="mem_id" placeholder="아이디는 첫글자 영문으로. 영문, 숫자 조합 4~11글자만 가능합니다." class="validate">
			      <label for="icon_name">ID</label>
			    </div>
			    <div class="input-field col s6 offset-s3">
			      <i class="material-icons prefix">vpn_key</i>
			      <input id="icon_password" type="password" name="mem_pwd" placeholder="비밀번호는 첫글자 영문으로. 영문, 숫자 조합 4~11글자만 가능합니다." class="validate">
