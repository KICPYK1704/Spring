		...
		<div class="row center-align">
			<form class="col s12 center" action="memberregister" name="memberregister" method="post">
			    <div class="input-field col s6 offset-s3">
			      ...
			      <input id="icon_prefix" type="text" name ="des_id" value="${dto.des_id}" placeholder="아이디는 첫글자 영문으로. 영문, 숫자 조합 4~11글자만 가능합니다." class="validate">
			      <label for="icon_name">ID</label>
			    </div>
			    <div class="input-field col s6 offset-s3">
			      <i class="material-icons prefix">vpn_key</i>
			      <input id="icon_password" type="password" name="des_pwd" value="${dto.des_pwd}" placeholder="비밀번호는 첫글자 영문으로. 영문, 숫자 조합 4~11글자만 가능합니다." class="validate">
			    ...
			    <div class="input-field col s6 offset-s3">
			      ...
			      <input id="des_shoptitle" type="text" name="des_shoptitle" value="${dto.des_shoptitle}" class="validate">
			      <label for="des_shoptitle">디나이너 스토어 이름</label>
			    </div>
			    <div class="input-field col s6 offset-s3">
			      <i class="material-icons prefix">art_track</i>
			      <textarea id="des_shopintro" name="des_shopintro" class="materialize-textarea" data-length="70">${dto.des_shopintro}</textarea>
			    ...
			    <div class="input-field col s6 offset-s3">
			      ...
			      <input id="icon_address" type="text" name="des_style" value="${dto.des_style}" class="validate">
			      <label for="icon_address">스타일</label>
			    </div>
				<div class="input-field col s6 offset-s3">
			      <i class="material-icons prefix">credit_card</i>
			      <input id="icon_account" type="text" name="des_account" value="${dto.des_account}" class="validate" placeholder="국민 000-00-0000-000">
